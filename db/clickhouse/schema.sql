...
CREATE TABLE talivia.event_data
(
    website_id UUID,
    session_id UUID,
    event_id UUID,
...
(
    ...
    gclsrc SimpleAggregateFunction(groupArrayArray, Array(String)),
    wbraid SimpleAggregateFunction(groupArrayArray, Array(String)),
    gbraid SimpleAggregateFunction(groupArrayArray, Array(String)),
...
-- revenue
CREATE TABLE talivia.website_revenue
(
    website_id UUID,
    session_id UUID,
    event_id UUID,
...
CREATE MATERIALIZED VIEW talivia.website_revenue_mv
TO talivia.website_revenue
AS
SELECT DISTINCT
    ed.website_id,
    ed.session_id,
