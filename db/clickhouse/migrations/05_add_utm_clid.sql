-- Create Event
CREATE TABLE talivia.website_event_new
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
-- stats hourly
CREATE TABLE talivia.website_event_stats_hourly_new
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
CREATE MATERIALIZED VIEW talivia.website_event_stats_hourly_mv_new
TO talivia.website_event_stats_hourly_new
AS
SELECT
    website_id,
    session_id,
...
FROM talivia.website_event_new
GROUP BY website_id,
    session_id,
    visit_id,
    hostname,
...
-- projections
ALTER TABLE talivia.website_event_new
ADD PROJECTION website_event_url_path_projection (
SELECT * ORDER BY toStartOfDay(created_at), website_id, url_path, created_at
);

ALTER TABLE talivia.website_event_new MATERIALIZE PROJECTION website_event_url_path_projection;
...
ALTER TABLE talivia.website_event_new MATERIALIZE PROJECTION website_event_referrer_domain_projection;

-- migration
INSERT INTO talivia.website_event_new
...
-- rename tables
RENAME TABLE talivia.website_event TO talivia.website_event_old;
RENAME TABLE talivia.website_event_new TO talivia.website_event;

RENAME TABLE talivia.website_event_stats_hourly TO talivia.website_event_stats_hourly_old;
RENAME TABLE talivia.website_event_stats_hourly_new TO talivia.website_event_stats_hourly;

RENAME TABLE talivia.website_event_stats_hourly_mv TO talivia.website_event_stats_hourly_mv_old;
RENAME TABLE talivia.website_event_stats_hourly_mv_new TO talivia.website_event_stats_hourly_mv;

-- recreate view
DROP TABLE talivia.website_event_stats_hourly_mv;
