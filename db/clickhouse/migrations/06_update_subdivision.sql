-- drop projections
ALTER TABLE talivia.website_event  DROP PROJECTION website_event_url_path_projection;
ALTER TABLE talivia.website_event  DROP PROJECTION website_event_referrer_domain_projection;

--drop view
DROP TABLE talivia.website_event_stats_hourly_mv;

-- rename columns
ALTER TABLE talivia.website_event RENAME COLUMN "subdivision1" TO "region";
ALTER TABLE talivia.website_event_stats_hourly RENAME COLUMN "subdivision1" TO "region";

-- drop columns
ALTER TABLE talivia.website_event DROP COLUMN "subdivision2";
...
ALTER TABLE talivia.website_event MATERIALIZE PROJECTION website_event_url_path_projection;
...
ALTER TABLE talivia.website_event MATERIALIZE PROJECTION website_event_referrer_domain_projection;
