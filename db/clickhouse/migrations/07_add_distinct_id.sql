-- add tag column
ALTER TABLE talivia.website_event ADD COLUMN "distinct_id" String AFTER "tag";
ALTER TABLE talivia.website_event_stats_hourly ADD COLUMN "distinct_id" String AFTER "tag";
ALTER TABLE talivia.session_data ADD COLUMN "distinct_id" String AFTER "data_type";
