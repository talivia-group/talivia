import { Column, Focusable, Icon, Row, Text, Tooltip, TooltipTrigger } from '@talivia/react-zen';
                        ...
                        >
                          ...
                          >
                            ...
                            <div className={styles.count} title={nodeCount}>
                              ...
                              >
                                <Focusable>
                                  <div role="button">{formatLongNumber(nodeCount)}</div>
                                </Focusable>
                                <Tooltip placement="top" offset={20} className="talivia-tooltip">
