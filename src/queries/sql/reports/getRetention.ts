  ...
  return rawQuery(
    ...
    WITH cohort_items AS (
      ...
      where website_event.website_id = {{websiteId::uuid}}
        ...
        ${filterQuery}
        and website_event.visitor_id is not null
      group by website_event.visitor_id
    ),
    user_activities AS (
      select distinct
        website_event.visitor_id,
      ...
      from website_event
      join cohort_items
      on website_event.visitor_id = cohort_items.visitor_id
...
async function clickhouseQuery(
  ...
  return rawQuery(
    ...
    user_activities AS (
      select distinct
        website_event.visitor_id as visitor_id,
