export const AUTH_TOKEN = 'talivia.auth';
export const LOCALE_CONFIG = 'talivia.locale';
export const TIMEZONE_CONFIG = 'talivia.timezone';
export const DATE_RANGE_CONFIG = 'talivia.date-range';
export const CURRENCY_CONFIG = 'talivia.currency';
export const DASHBOARD_CONFIG = 'talivia.dashboard';
export const LAST_TEAM_CONFIG = 'talivia.last-team';
export const LAST_WEBSITE_CONFIG = 'talivia.last-website';
export const SHARE_TOKEN_HEADER = 'x-talivia-share-token';
export const SHARE_CONTEXT_HEADER = 'x-talivia-share-context';
...
export const APP_LAYOUT_MAX_WIDTH = '1080px';
...
export const WEBSITE_MEMBER_ROLES = {
  viewer: 'viewer',
  member: 'member',
} as const;
