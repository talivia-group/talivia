...
export function getFragmentChildren(children: ReactNode) {
  return (children as ReactElement<any>)?.type === Fragment
    ? (children as ReactElement<any>).props.children
    : children;
}

export function isValidChild(child: ReactElement<any>, types: FC | FC[]) {
...
export function mapChildren(
  children: ReactNode,
  handler: (child: ReactElement<any>, index: number) => any,
) {
  return Children.map(getFragmentChildren(children) as ReactElement<any>[], (child, index) => {
    if (!child?.props) {
      return null;
    }
...
export function renderChildren(
  ...
  items: any[],
  handler: (child: ReactElement<any>, index: number) => object | undefined,
  options?: { validChildren?: any[]; onlyRenderValid?: boolean },
): ReactNode {
